...
import thirdparty.fr.inria.optimization.cmaes.CMAEvolutionStrategy;
import thirdparty.fr.inria.optimization.cmaes.CMAOptions;
import thirdparty.fr.inria.optimization.cmaes.CMASolution;
import thirdparty.fr.inria.optimization.cmaes.fitness.FunctionCollector;
import thirdparty.fr.inria.optimization.cmaes.fitness.IObjectiveFunction;

/**  
 * Example of how to use the class CMAEvolutionStrategy including 
 * restarts with increasing 
 * population size (IPOP). Copy and modify the code to your convenience. 
 * Final termination criteria
 * are stopFitness and stopMaxFunEvals (see class {@link CMAOptions}). 
 * The remaining  
