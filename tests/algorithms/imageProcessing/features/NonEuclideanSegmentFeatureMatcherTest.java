 ...
 * @author nichole
 */
public class NonEuclideanSegmentFeatureMatcherTest extends TestCase {
...
settings.setDebug(true);        
        ...
        List<PairInt> matched1 = matcher.getSolutionMatched1();
        
        List<PairInt> matched2 = matcher.getSolutionMatched2();
        
        assertNotNull(matched1);
                
        assertTrue(matched1.size() > 0);
        
        assertNotNull(matched2);
                
        assertTrue(matched2.size() > 0);
     ...
     public static void main(String[] args) {
        ...
        try {
            NonEuclideanSegmentFeatureMatcherTest test = new NonEuclideanSegmentFeatureMatcherTest();
            //test.test0();
            //test.testRot90();
