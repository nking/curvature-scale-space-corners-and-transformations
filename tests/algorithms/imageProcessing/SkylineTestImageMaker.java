    ...
    */
    ...
    private void writeLDADataFile(String fileName) throws Exception {
        ...
        */
        ...
        /*
        TODO:  the center should be w.r.t. CIE (x,y) (0.35, 0.35)
...
//this *has* to rebuild the clauses as currently in the code.
        ...
        float coeff0 = 30.0f;
        ANDedClauses cl0 = new ANDedClauses(
        ...
        float coeff1 = 0.5f;
        float coeff2 = 1.5f * coeff1 * 3.5f;
        float coeff3 = 0.5f;
        float coeff4 = 1.5f * coeff3 * 3.5f;
        ANDedClauses cl1 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL}, 
            new PARAM[]{PARAM.ABSOLUTE_CONTRAST, PARAM.ABSOLUTE_CONTRAST, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED}, 
            new PARAM[]{PARAM.INT_ONE,           PARAM.STDEV_CONTRAST,    PARAM.INT_ONE,                   PARAM.STDEV_BLUE_OR_RED}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff1, coeff2, coeff3, coeff4});
       
        /*
        // Filter 10 in 4 ANDed OR clauses
        float coeff5 = 5.0f;
        float coeff6 = 5.0f;
        float coeff7 = 0.001f;
        float coeff8 = 0.005f;
        float coeff9 = 1.0f;
        ANDedClauses cl2 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL}, 
            new PARAM[]{PARAM.ABSOLUTE_CONTRAST, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEX, 
                PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED}, 
            new PARAM[]{PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED, PARAM.INT_ONE,
                PARAM.INT_ONE, PARAM.INT_ONE}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff5, coeff6, coeff7, coeff8, coeff9});
        ANDedClauses cl3 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL}, 
            new PARAM[]{PARAM.ABSOLUTE_CONTRAST, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEY, 
                PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED}, 
            new PARAM[]{PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED, PARAM.INT_ONE,
                PARAM.INT_ONE, PARAM.INT_ONE}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff5, coeff6, coeff7, coeff8, coeff9});
        float coeff10 = 1.5f;
        ANDedClauses cl4 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL}, 
            new PARAM[]{PARAM.ABSOLUTE_CONTRAST, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEX, 
                PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED}, 
            new PARAM[]{PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED, PARAM.STDEV_CIEX,
                PARAM.INT_ONE, PARAM.INT_ONE}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff5, coeff6, coeff10, coeff8, coeff9});
        ANDedClauses cl5 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL, SKYCONDITIONAL.ALL}, 
            new PARAM[]{PARAM.ABSOLUTE_CONTRAST, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEY, 
                PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED}, 
            new PARAM[]{PARAM.STDEV_CONTRAST, PARAM.STDEV_BLUE_OR_RED, PARAM.STDEV_CIEY,
                PARAM.INT_ONE, PARAM.INT_ONE}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff5, coeff6, coeff10, coeff8, coeff9});
        */
        
        // red skies filter: extreme color diff, and small contrast change:
        float coeff11 = 10.f;
        float coeff12 = 0.02f;
        float coeff13 = 1.5f;
        ANDedClauses cl6 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.RED, SKYCONDITIONAL.RED, SKYCONDITIONAL.RED}, 
            new PARAM[]{PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEX, PARAM.DIFF_CIEX}, 
            new PARAM[]{PARAM.STDEV_BLUE_OR_RED,         PARAM.INT_ONE,   PARAM.STDEV_CIEX}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff11, coeff12, coeff13});
        
        // for red skies, significant color change in red and CIEX
        float coeff14 = 3.f;
        float coeff15 = 0.03f;
        float coeff16 = 3.0f;
        float coeff17 = 2.73f;
        float coeff18 = coeff17 * coeff14;
        float coeff19 = coeff17 * coeff15;
        float coeff20 = coeff17 * coeff16;
        ANDedClauses cl7 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.RED, SKYCONDITIONAL.RED, SKYCONDITIONAL.RED}, 
            new PARAM[]{PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEX, PARAM.DIFF_CIEX}, 
            new PARAM[]{PARAM.STDEV_BLUE_OR_RED,         PARAM.INT_ONE,   PARAM.STDEV_CIEX}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff14, coeff15, coeff16});
        ANDedClauses cl8 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.RED, SKYCONDITIONAL.RED, SKYCONDITIONAL.RED}, 
            new PARAM[]{PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEX, PARAM.DIFF_CIEX}, 
            new PARAM[]{PARAM.STDEV_BLUE_OR_RED,         PARAM.INT_ONE,   PARAM.STDEV_CIEX}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff18, coeff19, coeff20});
        ANDedClauses cl9 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.RED, SKYCONDITIONAL.RED, SKYCONDITIONAL.RED}, 
            new PARAM[]{PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEY, PARAM.DIFF_CIEY}, 
            new PARAM[]{PARAM.STDEV_BLUE_OR_RED,         PARAM.INT_ONE,   PARAM.STDEV_CIEY}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff14, coeff15, coeff16});
        ANDedClauses cl10 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.RED, SKYCONDITIONAL.RED, SKYCONDITIONAL.RED}, 
            new PARAM[]{PARAM.ABSOLUTE_DIFF_BLUE_OR_RED, PARAM.DIFF_CIEY, PARAM.DIFF_CIEY}, 
            new PARAM[]{PARAM.STDEV_BLUE_OR_RED,         PARAM.INT_ONE,   PARAM.STDEV_CIEY}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff18, coeff15, coeff16});
        
        // for blue skies
        float coeff21 = 0.05f;
        float coeff22 = 0.005f;
        float coeff23 = 1.1f;
        ANDedClauses cl11 = new ANDedClauses(
            new SKYCONDITIONAL[]{SKYCONDITIONAL.BLUE, SKYCONDITIONAL.BLUE, SKYCONDITIONAL.BLUE,
                SKYCONDITIONAL.BLUE, SKYCONDITIONAL.BLUE, SKYCONDITIONAL.BLUE}, 
            new PARAM[]{PARAM.ABSOLUTE_DIFF_BLUE_OR_RED,  PARAM.DIFF_CIEX,  PARAM.DIFF_CIEX,
                PARAM.ABSOLUTE_CONTRAST, PARAM.STDEV_CONTRAST, PARAM.ABSOLUTE_DIFF_BLUE_OR_RED}, 
            new PARAM[]{PARAM.STDEV_BLUE_OR_RED,          PARAM.STDEV_CIEX, PARAM.STDEV_CIEX,
                PARAM.INT_ONE,           PARAM.INT_ONE,        PARAM.INT_ONE}, 
            new COMPARISON[]{COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN,
                COMPARISON.LESS_THAN,    COMPARISON.GREATER_THAN, COMPARISON.GREATER_THAN}, 
            new float[]{coeff14, coeff16, coeff16, coeff21, coeff22, coeff23});
        
        /* small or negative contrast and no color change and not a bright grey cloud:
           5 more clauses
        (contrastV < 0.05)
