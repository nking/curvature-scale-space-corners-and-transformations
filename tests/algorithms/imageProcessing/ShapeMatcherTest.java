...
public class ShapeMatcherTest extends TestCase {
    ...
    public void testDitherToFindBestStat() throws Exception {
        ...
        if (fileName1.contains("brown_lowe")) {
            ...
            */
            ...
            FeatureComparisonStat stat0 = matcher.ditherToFindBestStat(
                img1, img2, x1, y1, x2, y2, offsetsT, offsets0, dither2);
            
            int deltaX = x1 - stat0.img1Point.getX();
            int deltaY = y1 - stat0.img1Point.getY();
            ...
            x1 = 139; y1 = 59;
            x2 = 49; y2 = 56;
            FeatureComparisonStat stat1 = matcher.ditherToFindBestStat(
                img1, img2, x1, y1, x2, y2, offsetsT, offsets0, dither2);
            
            deltaX = x1 - stat1.img1Point.getX();
            deltaY = y1 - stat1.img1Point.getY();
        ...
        for (int i = 0; i < points1.getN(); ++i) {
            ...
            FeatureComparisonStat stat = matcher.ditherToFindBestStat(
            ...
            int deltaX = x1 - stat.img1Point.getX();
            int deltaY = y1 - stat.img1Point.getY();
