...
import algorithms.compGeometry.clustering.twopointcorrelation.*;
...
public aspect TwoPointVoidStatsAspect {
	...
	call(void algorithms.compGeometry.clustering.twopointcorrelation.TwoPointVoidStats.findVoidsRoughRangeSearch( int, int, int, int, int, float ) ) && args(xIndexLo, xIndexHi, yIndexLo, yIndexHi, nDiv, bFactor)
	{
