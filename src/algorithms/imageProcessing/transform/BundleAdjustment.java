...
System.out.flush();
        ...
        double[][] tmp2 = MatrixUtil.zeros(3, 9);
        ...
        for (i = 0; i < nFeatures; ++i) {
            ...
            for (j = 0; j < mImages; ++j) {
                ...
                MatrixUtil.multiply(invHPPI, auxHPC, tmp2);
                MatrixUtil.multiplyMatrixByColumnVector(tmp2, dCJ, tmp);
                
                MatrixUtil.elementwiseSubtract(tP, tmp, tP);
