...
extends AbstractCurvatureScaleSpaceInflectionMapper {
    ...
    public CurvatureScaleSpaceInflectionMapperForOpenCurves(ImageExt image1, 
        ImageExt image2) {
    ...
    protected void createMatchedPointArraysFromContourPeaks() {
        ...
        //TODO: tolerance may need to be increased here above delta/2
        int deltaTransX = 4; 
        int deltaTransY = 4; 
        float tolTransX = deltaTransX; 
        float tolTransY = deltaTransY;
