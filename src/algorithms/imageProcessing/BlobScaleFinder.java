...
public class BlobScaleFinder {
    ...
    public TransformationParameters calculateScale(ImageExt img1, 
        ...
        */
        ...
        Map<PairIntArray, Set<PairIntArray>> filteredBlobMatches =
            filterBlobsByFeatures(img1Binned, img2Binned, blobs1, blobs2);
    ...
    private Map<PairIntArray, Set<PairIntArray>> filterBlobsByFeatures(ImageExt img1Binned, ImageExt img2Binned, List<Set<PairInt>> blobs1, List<Set<PairInt>> blobs2) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private TransformationParameters solveForScale(Map<PairIntArray, Set<PairIntArray>> filteredBlobMatches, List<Set<PairInt>> blobs1, List<Set<PairInt>> blobs2, List<PairIntArray> bounds1, List<PairIntArray> bounds2, int xRelativeOffset, int yRelativeOffset, int xRelativeOffset0, int yRelativeOffset0) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
