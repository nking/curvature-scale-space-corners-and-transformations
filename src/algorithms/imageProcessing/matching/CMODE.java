...
public enum CMODE {
    ...
    public static CMODE determineColorMode(ImageExt img, Collection<PairInt> set) {
    ...
    public static CMODE determineColorMode(GreyscaleImage rImg, 
        GreyscaleImage gImg, GreyscaleImage bImg, Collection<PairInt> set) {

        GroupAverageColors clrs = new GroupAverageColors(rImg, gImg, bImg, set);
